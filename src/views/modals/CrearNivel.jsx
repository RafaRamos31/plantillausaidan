...
export const CrearNivel = ({handleClose, setRefetch, modalRefetch, modal=false}) => {
  ...
  const { setSend, send, data, isLoading, error } = useFetchPostBody('niveles', values) 
  ...
  return (
    ...
    <Card.Header className="d-flex justify-content-between align-items-center" style={{backgroundColor: 'var(--main-green)', color: 'white'}}>
      <h4 className="my-1">Crear Nivel</h4>
