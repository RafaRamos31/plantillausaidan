...
export const EventosTabla = () => {
  ...
  return(
    <>
    <Layout pagina={`Eventos - Crear`} SiteNavBar={EventosNavBar} breadcrumbs={[
        {link: '/', nombre: 'Inicio'},
        {link: '/eventos', nombre: 'Eventos'},
        {link: '/eventos/tabla', nombre: 'Crear'}
    ]}>
    ...
    <Modal show={showCreate} onHide={handleCloseCreate} backdrop="static">
      <CrearEvento handleClose={handleCloseCreate} setRefetch={handleUpdate}/>
    </Modal>
    </>
  );
}
