...
export const EventosAprobacionMEL = () => {
  ...
  return(
    <>
    <Layout pagina={`Revisión ${endpoint.charAt(0).toUpperCase() + endpoint.slice(1)}s`} SiteNavBar={MELNavBar} breadcrumbs={[
        {link: '/', nombre: 'Inicio'},
        {link: '/monitoreo', nombre: 'Monitoreo'},
        {link: '/monitoreo/aprobacion', nombre: 'Aprobar Evento'},
    ]}>
