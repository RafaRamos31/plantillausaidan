...
import { CrearArea } from "./modals/CrearArea.jsx";
import { EditArea } from "./modals/EditArea.jsx";
import { InfoLink } from "../components/InfoLink.jsx";

export const ConfigAreas = () => {
  //Peticio de datos a la API
  const { data, isLoading, setRefetch } = useFetchGet('areas');
  const handleRefetch = () => {
    setRefetch(true)
  }
  ...
  return(
    <>
    <Layout pagina={'Configuracion - Áreas Temáticas'} SiteNavBar={ConfigNavBar}>
    ...
    <Modal show={showCreate} onHide={handleCloseCreate} backdrop="static">
      <CrearArea handleClose={handleCloseCreate} setRefetch={handleRefetch}/>
    </Modal>
    </>
  );
}
