...
export const ReviewsAreasTematicas = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <a href={`/reviews/areastematicas/${params.row.uuid}`} target="_blank" rel="noreferrer">
  ...
  return(
    <>
    <Layout pagina={`Revisión Áreas Temáticas`} SiteNavBar={IndicadoresNavBar} breadcrumbs={[
        {link: '/', nombre: 'Inicio'},
      ...
      <div className="d-flex align-items-center">
        <h4><i className="bi bi-diagram-3-fill"></i>{` Revisión Áreas Temáticas`}</h4>
        {/*Boton Actualizar*/}
        {
          !updating ? 
