...
import { EditOrgtype } from '../../modals/EditOrgtype';

export const ReviewOrgType = () => {
  ...
  const { setSend, send, data, isLoading, error } = useFetchPutBody(`revisiones/${endpoint}es`, values) 
  ...
  const handleSuccess = () => {
    ...
    setCharging(false)
    setShowToast(true)
    actualizarTitulo(`Tipo de Organización Revisado`)
    setContent(`Tipo de Organización revisado correctamente.`)
    setVariant('success')
  }
  ...
  return (
          ...
          <Container style={{border: '1px solid lightgray', padding: '1.5rem', borderRadius: '10px', marginTop: '1rem'}}>
            <Row>
              <Col md={6}>
                ...
                <CompareValue  title={'Tipo de Organización:'} value={dataRevision.nombre} original={original?.nombre} compare={compare}/>
              ...
              </Col>
              {
                ...
                <Col md={6}>
                  ...
                  <CompareValue  title={'Tipo de Organización:'} value={dataRevision.nombre} original={original?.nombre} compare={compare} hidden/>
    ...
    <Modal show={showEdit} onHide={handleCloseEdit} backdrop="static">
      <EditOrgtype handleClose={handleCloseEdit} setRefetchData={()=>{}} orgtype={{...dataRevision, id: original?._id}} fixing/>
    </Modal>
    </>
  )
}
