...
import { EditAldea } from '../../modals/EditAldea';
import { UserContext } from '../../../contexts/UserContext';

export const ReviewAldea = () => {
  ...
  return (
    ...
    <Layout pagina={`Revisión ${endpoint.charAt(0).toUpperCase() + endpoint.slice(1)}`} SiteNavBar={ConfigNavBar} breadcrumbs={[
        ...
        {link: '/configuracion/aldeas', nombre: 'Aldeas'},
        {link: '/reviews/aldeas', nombre: 'Revisiones'},
        {link: `/reviews/aldeas/${idRevision}`, nombre: dataRevision?.nombre || 'Revisión'}
    ]}>
      <Row className='mx-0 my-0'>
          ...
          <Container style={{border: '1px solid lightgray', padding: '1.5rem', borderRadius: '10px', marginTop: '1rem'}}>
            <Row>
              <Col md={6}>
                ...
                <CompareValue  title={'Nombre de la Aldea:'} value={dataRevision.nombre} original={original?.nombre} compare={compare}/>
              ...
              </Col>
              {
                ...
                <Col md={6}>
                  ...
                  <CompareValue  title={'Nombre de la Aldea:'} value={dataRevision.nombre} original={original?.nombre} compare={compare} hidden/>
        ...
        <Col md={4}>
          <Form onSubmit={handleSubmit}>
            ...
            {
              user.userPermisos?.acciones['Aldeas']['Eliminar'] 
              &&
    ...
    <Modal show={showEdit} onHide={handleCloseEdit} backdrop="static">
      <EditAldea handleClose={handleCloseEdit} setRefetchData={()=>{}} aldea={{...dataRevision, id: original?._id}} fixing/>
    </Modal>
    </>
  )
}
