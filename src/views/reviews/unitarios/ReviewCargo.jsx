          ...
          <Container style={{border: '1px solid lightgray', padding: '1.5rem', borderRadius: '10px', marginTop: '1rem'}}>
            <Row>
              <Col md={6}>
                ...
                <CompareValue  title={'Nombre del Cargo:'} value={dataRevision.nombre} original={original?.nombre} compare={compare}/>
              ...
              </Col>
              {
                ...
                <Col md={6}>
                  ...
                  <CompareValue  title={'Nombre del Cargo:'} value={dataRevision.nombre} original={original?.nombre} compare={compare} hidden/>
