...
export const ReviewUsuario = () => {
  ...
  return (
      ...
      <Row className='mx-0 my-0'>
          ...
          <Container style={{border: '1px solid lightgray', padding: '1.5rem', borderRadius: '10px', marginTop: '1rem'}}>
            <Row>
              <Col md={6}>
                ...
                <CompareValue  title={'Correo electrónico:'} value={dataRevision.correo} original={original?.correo} compare={compare}/>
              </Col>
              {
                compare &&
                <Col md={6}>
                  ...
                  <CompareValue  title={'Componente:'} value={dataRevision.componente?.nombre} original={original?.componente?.nombre} compare={compare} hidden/>
                  {
                    dataRevision.rol &&
                    <CompareValue  title={'Rol:'} value={dataRevision.rol?.nombre} original={original?.rol?.nombre} compare={compare} hidden/>
                  }
                  <CompareValue  title={'Teléfono:'} value={dataRevision.telefono} original={original?.telefono} compare={compare} hidden/>
                  <CompareValue  title={'Correo electrónico:'} value={dataRevision.correo} original={original?.correo} compare={compare} hidden/>
                </Col>
              }
            </Row>
        ...
        <Col md={4}>
          <Form onSubmit={handleSubmit}>
            ...
            {
              user.userPermisos?.acciones['Usuarios']['Eliminar'] 
              &&
    ...
    <Modal show={showEdit} onHide={handleCloseEdit} backdrop="static">
      <EditUsuario handleClose={handleCloseEdit} setRefetchData={()=>{}} usuario={{...dataRevision, id: original?._id}} fixing/>
    </Modal>
    </>
  )
}
