...
export const ReviewCaserio = () => {
  ...
  return (
    ...
    <Layout pagina={`Revisión ${endpoint.charAt(0).toUpperCase() + endpoint.slice(1)}`} SiteNavBar={ConfigNavBar} breadcrumbs={[
        ...
        {link: `/reviews/caserios/${idRevision}`, nombre: dataRevision?.nombre || 'Revisión'}
    ]}>
      <Row className='mx-0 my-0'>
          ...
          <Container style={{border: '1px solid lightgray', padding: '1.5rem', borderRadius: '10px', marginTop: '1rem'}}>
            <Row>
              <Col md={6}>
                ...
                <CompareValue  title={'Nombre del Caserio:'} value={dataRevision.nombre} original={original?.nombre} compare={compare}/>
              ...
              </Col>
              {
                ...
                <Col md={6}>
                  ...
                  <CompareValue  title={'Nombre del Caserio:'} value={dataRevision.nombre} original={original?.nombre} compare={compare} hidden/>
        ...
        <Col md={4}>
          <Form onSubmit={handleSubmit}>
            ...
            {
              user.userPermisos?.acciones['Caserios']['Eliminar'] 
              &&
