...
export const ReviewQuarter = () => {
  ...
  const handleSuccess = () => {
    ...
    setCharging(false)
    setShowToast(true)
    actualizarTitulo(`Trimestre Revisado`)
    setContent(`Trimestre revisado correctamente.`)
    setVariant('success')
  }
  ...
  return (
    <>
    <Layout pagina={`Revisión Trimestres`} SiteNavBar={IndicadoresNavBar} breadcrumbs={[
        {link: '/', nombre: 'Inicio'},
        {link: '/indicadores', nombre: 'Indicadores'},
        {link: '/indicadores/quarters', nombre: 'Trimestres'},
        {link: '/reviews/quarters', nombre: 'Revisiones'},
        {link: `/reviews/quarters/${idRevision}`, nombre: dataRevision?.nombre || 'Revisión'}
    ]}>
      <Row className='mx-0 my-0'>
        <Col md={8}>
          <h2><i className="bi bi-calendar2-week"></i>{` Trimestre`}</h2>
          ...
          <Container style={{border: '1px solid lightgray', padding: '1.5rem', borderRadius: '10px', marginTop: '1rem'}}>
            <Row>
              <Col md={6}>
                ...
                <CompareValue  title={'Trimestre:'} value={dataRevision.nombre} original={original?.nombre} compare={compare}/>
              ...
              </Col>
              {
                ...
                <Col md={6}>
                  ...
                  <CompareValue  title={'Trimestre:'} value={dataRevision.nombre} original={original?.nombre} compare={compare} hidden/>
        ...
        <Col md={4}>
          <Form onSubmit={handleSubmit}>
            ...
            {
              user.userPermisos?.acciones['Trimestres']['Eliminar'] 
              &&
