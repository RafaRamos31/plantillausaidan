...
export const ReviewsActividades = () => {
  ...
  return(
    <>
    <Layout pagina={`Revisión ${endpoint.charAt(0).toUpperCase() + endpoint.slice(1)}es`} SiteNavBar={PlanNavBar} breadcrumbs={[
        {link: '/', nombre: 'Inicio'},
      ...
      <div className="d-flex align-items-center">
        <h4><i className="bi bi-stack"></i>{` Revisión ${endpoint.charAt(0).toUpperCase() + endpoint.slice(1)}es`}</h4>
        {/*Boton Actualizar*/}
        {
          !updating ? 
