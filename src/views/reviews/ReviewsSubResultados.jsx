...
export const ReviewsSubResultados = () => {
  ...
  return(
    <>
    <Layout pagina={`Revisión Sub Resultados`} SiteNavBar={PlanNavBar} breadcrumbs={[
        {link: '/', nombre: 'Inicio'},
      ...
      <div className="d-flex align-items-center">
        <h4><i className="bi bi-bar-chart-line"></i>{` Revisión Sub Resultados`}</h4>
        {/*Boton Actualizar*/}
        {
          !updating ? 
