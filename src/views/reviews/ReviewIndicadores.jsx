...
export const ReviewsIndicadores = () => {
  ...
  return(
    <>
    <Layout pagina={`Revisión ${endpoint.charAt(0).toUpperCase() + endpoint.slice(1)}es`} SiteNavBar={IndicadoresNavBar} breadcrumbs={[
        {link: '/', nombre: 'Inicio'},
      ...
      <div className="d-flex align-items-center">
        <h4><i className="bi bi-graph-up-arrow"></i>{` Revisión ${endpoint.charAt(0).toUpperCase() + endpoint.slice(1)}es`}</h4>
        {/*Boton Actualizar*/}
        {
          !updating ? 
