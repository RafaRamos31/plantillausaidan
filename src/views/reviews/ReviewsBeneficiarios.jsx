...
export const ReviewsBeneficiarios = () => {
  ...
  const columns = [
    ...
    { field: 'uuid', headerName: 'uuid', width: 100, description: 'Identificador unico del registro en la Base de Datos.' },
    { field: 'original', headerName: 'Original', width: 100,
      renderCell: (params) => {
        return (
          <InfoLink
            type={'beneficiarios'}
