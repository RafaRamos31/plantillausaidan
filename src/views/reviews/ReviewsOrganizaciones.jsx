...
export const ReviewsOrganizaciones = () => {
  ...
  return(
    <>
    <Layout pagina={`Revisión ${endpoint.charAt(0).toUpperCase() + endpoint.slice(1)}es`} SiteNavBar={ClientesNavBar} breadcrumbs={[
        {link: '/', nombre: 'Inicio'},
      ...
      <div className="d-flex align-items-center">
        <h4><i className="bi bi-bank2"></i>{` Revisión ${endpoint.charAt(0).toUpperCase() + endpoint.slice(1)}es`}</h4>
        {/*Boton Actualizar*/}
        {
          !updating ? 
