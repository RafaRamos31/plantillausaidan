    ...
    { field: 'indicadores', headerName: 'Indicadores', width: 400, filterable: false,
      renderCell: (params) => (
        JSON.parse(params.formattedValue).map(indicador => (
          <MuiTooltip key={indicador.id} title={indicador.descripcion} placement="top" arrow followCursor>
            <Chip key={indicador.id} className="mx-1" label={indicador.nombre} style={{cursor: 'help'}}/>
          </MuiTooltip>
        ))
    )},
