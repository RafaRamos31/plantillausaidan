                    ...
                    <Container style={{border: '1px solid lightgray', padding: '1.5rem', borderRadius: '10px', marginTop: '0.2rem'}}>
                      <Row>
                        <Col md={6}>
                          ...
                          <CompareValue  title={'Componente:'} value={rev.componente?.nombre} original={original?.componente?.nombre} compare={false}/>
                          {
                            rev.rol &&
                            <CompareValue  title={'Rol:'} value={rev.rol?.nombre} original={original?.rol?.nombre} compare={false}/>
                          }
                          <CompareValue  title={'Teléfono:'} value={rev.telefono} original={original?.telefono} compare={false}/>
                          <CompareValue  title={'Correo electrónico:'} value={rev.correo} original={original?.correo} compare={false}/>
                        </Col>
                      </Row>
                    </Container>
                  </Accordion.Body>
              ...
              <Accordion className='mx-0 my-0' defaultActiveKey={['status']} alwaysOpen>
                ...
                <Accordion.Item eventKey='info'>
                  ...
                  <Accordion.Body className='px-0 py-0'>
                    ...
                    <CompareValue  title={'Componente:'} value={original.componente?.nombre} original={original?.componente?.nombre} compare={false}/>
                    {
                      original.rol &&
                      <CompareValue  title={'Rol:'} value={original.rol?.nombre} original={original?.rol?.nombre} compare={false}/>
                    }
                    <CompareValue  title={'Teléfono:'} value={original.telefono} original={original?.telefono} compare={false}/>
                    <CompareValue  title={'Correo electrónico:'} value={original.correo} original={original?.correo} compare={false}/>
                    </Container>
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
