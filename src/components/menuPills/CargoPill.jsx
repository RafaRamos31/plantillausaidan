...
export const CargoPill = ({data}) => {
  return (
    <Link className='pill' to={`/info/cargo/${data._id}`} style={{textDecoration: 'none'}}>
      <Card style={{ width: '15rem', margin: '0.5rem' }}>
        <Card.Body className='pill-body d-flex justify-content-center align-items-center m-0 p-0'>
          <i className="bi bi-person-badge" style={{color: 'var(--main-green', fontSize: '5rem'}}></i>
        </Card.Body>
