...
export const OrganizacionPill = ({data}) => {
  return (
    <Link className='pill' to={`/info/organizacion/${data._id}`} style={{textDecoration: 'none'}}>
      <Card style={{ width: '15rem', margin: '0.5rem' }}>
        ...
        <Card.Footer className='d-flex justify-content-center align-items-center'>
          <Card.Title style={{textAlign: 'center'}}>{data.nombre}</Card.Title>
        </Card.Footer>
      </Card>
    </Link>
  )
